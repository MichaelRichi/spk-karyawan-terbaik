...
<div class="card">
    ...
    <table class="table mb-0">
        <thead>
            <tr><th class="text-center" style="width:80px">Skor</th><th>Deskripsi</th><th class="text-center">Aksi</th></tr>
        </thead>
        <tbody>
        ...
        <div class="modal-content" style="border:0.5px solid #e2e8f0;border-radius:10px">
            ...
            <form id="sk-form" method="POST" action="{{ route('kriteria.sub-kriteria', $kriteria) }}">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <deskripsi class="form-deskripsi">Skor <span style="color:#ef4444">*</span></deskripsi>
